...
class TestReportModeRouting:
    ...
    def test_kimi_llm_uses_normalized_model(self, monkeypatch):
        ...
        srv = _reload_server_with_env(KIMI_MODEL="k3", KIMI_API_KEY="sk-test-key")
    ...
    def test_kimi_k3_forces_model(self, monkeypatch):
        ...
        monkeypatch.setenv("KIMI_API_KEY", "sk-test-key")
        srv = _reload_server_with_env(KIMI_MODEL="kimi-k2.7-code", KIMI_API_KEY="sk-test-key")
    ...
    def test_jina_llm_uses_deepseek(self, monkeypatch):
        ...
        monkeypatch.setenv("LLM_API_KEY", "sk-deepseek-test")
        srv = _reload_server_with_env(LLM_API_KEY="sk-deepseek-test")
