...
> **All figures are self-reported and unverified.** Outcomes are as _he_
...
- **AXTI** — the flagship. Identified the InP bottleneck at ~$700M MC before the
  ...
  _process_ call (multi-hop supply-chain mapping that institutions confirmed
  later).
...
- **SNDK / MU memory supercycle** — MU GM predicted 73-75% in January, actual
  74.9% in March: a clean, falsifiable, _correct_ quantitative call.
...
- **IREN** — went _both ways_: a 2025 speculative bull that he bag-held into the
  December drop before flipping to an explicit, ultimately-correct bear. The bull
  leg was a loss; the bear leg was right. Net lesson: his views _change_, so a
...
- **ETOR** — disclosed as a cost-average _loser_ across 2025.
...
2. **Selection bias.** A public feed amplifies winners and dated thesis posts;
   losers and quiet exits get far less airtime. The corpus is _his_ record of
   _his_ calls.
3. **Survivorship.** He trades many volatile microcaps; a strategy of many
   ...
   That does not mean the _next_ one works.
4. **Theses decay and reverse.** IREN, CRWV, SNAP, HOOD, POET, LITE, AAOI all
   changed tier or direction within months. Always check the _latest_ stance in
   `theses.md`, not an old headline.
5. **Process > picks.** The most transferable, trustworthy part is his _method_
   (multi-hop bottleneck mapping, financing-quality screening, GAAP-margin
   discipline) — documented in `methodology.md`. Weight the _questions he asks_
   higher than the _tickers he names_, and confirm current price/fundamentals
