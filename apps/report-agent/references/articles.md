...
Do not commit full X Article text to this public repo. Store only metadata,
short summaries, durable thesis deltas, and portfolio-use rules. If private
local full-text caching is needed for personal research, keep it outside the
repo or under an ignored local path.
