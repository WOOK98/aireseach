...
- **Tier:** Bull, "safer compounder" / "Faster Compounders" list. Entry ~Mar 2026. +17% in days, +63% in two weeks.
...
- **Thesis:** Background infrastructure, not his primary trade. The NeoCloud
  ...
  _lagging_ indicator vs. hyperscaler capex. His $6B optical investments
...
- **MSFT:** Azure AI growth = demand confirmation; mostly macro framing. $350 (Mar 28) = "pricing in April tariff/liquidity shock."
...
- **TER, FORM, VIAV, ONTO, KLAC, AMAT, ASML, CAMT, KLIC, BESI** — test/equipment
  roundup mentions; FORM/VIAV used as _leading indicators_ for the optical cycle.
