...
# Source: skills/deep-dive/SKILL.md → packages/shared/src/skill-contract/generated_methodology.txt

SKILL_METHODOLOGY_PATH = (
...
def _load_skill_methodology() -> str:
    """Load build-time generated methodology. Falls back to empty if missing."""
    try:
        return SKILL_METHODOLOGY_PATH.read_text(encoding="utf-8").strip()
...
SKILL_METHODODOLOGY = _load_skill_methodology()
